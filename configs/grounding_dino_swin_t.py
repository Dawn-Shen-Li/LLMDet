...
lmm_max_token_length = 1600 # image-level token lenght is 1600, and region-level token length is 40 
num_region_caption = 16  # number of region captions per image. P4: 27x27, P5: 20x20 
use_short_cap=False
...
model = dict(
    ...
    lmm_connector='/data/huggingface/llmdet_llava-onevision-qwen2-0.5b-ov-2/mm_projector2.bin',
