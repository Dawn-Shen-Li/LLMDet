...
model = dict(
    ...
    as_two_stage=True,
    lmm='/data/huggingface/Qwen2-0.5B-Instruct-llava/',
    lmm_layers=1,
    lmm_loss_weight=1.0,
    lmm_connector='/data/huggingface/mm_projector.bin',
    fsdp=True,
...
train_pipeline = [
    ...
    dict(
        ...
        tokenizer_name2='/data/huggingface/llmdet_llava-onevision-qwen2-0.5b-ov-2/',
