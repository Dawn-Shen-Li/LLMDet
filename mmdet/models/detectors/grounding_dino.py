    ...
    def __init__(self,
        ...
        if lmm is not None:
            ...
            if self.use_p4_input:
                ...
                self.p5_grid_box = torch.cat([grid[:-1, :-1], grid[1:, 1:]], dim=-1).flatten(0, 1) # 20 x 20
